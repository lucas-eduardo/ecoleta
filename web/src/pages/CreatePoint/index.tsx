          ...
          <fieldset>
            ...
            <div className="field-group">
              <div className="field">
                ...
                <select name="uf" id="uf" defaultValue={selectedUf} onChange={handleSelectUf}>
              ...
              <div className="field">
                ...
                <select name="city" id="city" defaultValue={selectedCity} onChange={handleSelectCity}>
